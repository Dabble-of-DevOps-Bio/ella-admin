...
FRONTEND_URL = 'https://%s' % FRONTEND_DOMAIN
FRONTEND_ADMIN_URL = 'https://%s/%s' % (FRONTEND_DOMAIN, FRONTEND_ADMIN_ROUTE)
FRONTEND_ADMIN_RESET_PASSWORD_URL = 'https://%s/%s/%s?token=' % (FRONTEND_DOMAIN, FRONTEND_ADMIN_ROUTE, FRONTEND_ADMIN_RESET_PASSWORD_ROUTE)
